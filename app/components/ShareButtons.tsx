...
export default function SocialShare({
  title = `${CONSTANTS.BRAND_NAME} - Bester IPTV Anbieter Deutschland 2026`,
    ...
    return [
      {
        ...
        aria: 'Diese Seite über WhatsApp teilen',
      },
      {
        name: 'Facebook',
        ...
        aria: 'Diese Seite über Facebook teilen',
      },
      {
        name: 'X (Twitter)',
        ...
        aria: 'Diese Seite über X teilen',
      },
      {
        name: 'Telegram',
        ...
        aria: 'Diese Seite über Telegram teilen',
      },
      {
        name: 'LinkedIn',
        ...
        aria: 'Diese Seite über LinkedIn teilen',
      },
    ];
  }, [url, title]);
  ...
  return (
    <div className="w-full flex justify-center items-center px-4 my-8 relative z-10">
      <div className="w-full max-w-4xl bg-[#0a0a0c]/80 backdrop-blur-xl border border-white/15 rounded-2xl md:rounded-full py-3.5 px-6 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl transition-colors duration-300 hover:border-[#DD0000]/60">

        {/* Callout Header */}
        <div className="flex items-center justify-center gap-2.5 text-white shrink-0">
          <span className="p-2 rounded-full bg-[#DD0000] text-[#FFCE00]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 h-10 sm:h-11 rounded-full text-xs font-black uppercase tracking-wider border transition-all duration-200 active:scale-95 cursor-pointer shadow-sm ${
              copied
                ? 'bg-[#DD0000] text-white border-[#DD0000]'
                : 'bg-[#FFCE00] border-[#FFCE00] text-[#8C0000] hover:bg-[#DD0000] hover:text-white hover:border-[#DD0000]'
            }`}
          >
            {copied ? (
              <>
